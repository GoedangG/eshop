...
public class PaymentServiceImplTest {
    ...
    void setUp(){
        ...
        product.setProductName("Vega-R Aqmal");
        ...
        Map<String, String> paymentData2 = Map.of("bankName", "BCA", "referenceCode", "1234567890");

        Payment payment2 = new Payment("eb558e9f-1c39-460e-8860-71af6af63bd6", PaymentMethod.BANK_TRANSFER.getValue(), paymentData2);
